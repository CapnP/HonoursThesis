...
DAT043=1.p& 15422  &18.67&  12865  &26.08 & \textbf{N/A} & \textbf{N/A} \\
DAT048=1.p& 14186  &17.65&  16462  &35.77 & \textbf{N/A} & \textbf{N/A} \\ \hline
\end{tabular}\end{center}\end{table}

Of particular note are the two final problems, which the original version of \beagle\ 
was unable to solve and timed out after 8 hours. These two problems present
the second and third most superposition time for the enhanced version.
