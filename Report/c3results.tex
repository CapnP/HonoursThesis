...
to 259. Unfortunately however this improvement cannot be entirely attributed to
...
With this in mind the 95\% improvement is no longer relevant; and we must look into measures of
performance.

Notice however that the standard version of beagle only performs about 10\% more
superposition inferences than the enhanced version; making them much more comparable
on total time. Between these two versions we observe a total run time improvement
of 122 seconds, or about 2.5 seconds per problem.


\subsubsection{False Positives}
Only minor improvement in FP when going to enhanced. Mainly improves ARI do
to actual use of the prover.
