...
After implementing superposition the VisualVM tests were attempted again, with the intent
of confirming that Fingerprint Indexing was performing adequately before moving
on to index simplification.
