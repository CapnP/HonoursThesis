...
\begin{frame}
  \frametitle{Runtimes under 5 seconds}
                  %Left Bot Right Top
  \includegraphics[scale=0.56,trim=2.7cm 5cm 0cm 3cm,clip]{suptime}
\end{frame}

\begin{frame}
  \frametitle{Runtimes under 5 seconds}
                  %Left Bot Right Top
  \includegraphics[scale=0.56,trim=2.7cm 5cm 0cm 3cm,clip]{suptimetrends}
\end{frame}
...
\end{tabular}\end{table}
  \item<3-> When taking number of inferences into account for DAT038=1.p we observe
